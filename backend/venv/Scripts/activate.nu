...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Universität\UAS\Cloud Computing\Projects\pet-detection\backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Universität\UAS\Cloud Computing\Projects\pet-detection\backend\venv\Scripts\deactivate.nu'
